    ...
    >
      ...
      <div class="flex flex-col-reverse sm:flex-row items-center justify-end gap-3 pt-2">
        ...
        <NeoBrutalistButton
          type="button"
          @click="handleConfirm"
          class="w-full sm:w-auto px-5 py-2.5 bg-rose-400 hover:bg-rose-500 text-black text-xs sm:text-sm font-black shadow-[3px_3px_0px_0px_#000] dark:shadow-[3px_3px_0px_0px_#fff]"
        >
          {{ $t("practice.leaveBtn") }}
        </NeoBrutalistButton>
      </div>
